...
import edu.stevens.cs522.chat.oneway.server.ChatReceiverService;
import edu.stevens.cs522.chat.oneway.server.IChatSendService;
import edu.stevens.cs522.chat.oneway.server.PeerList;
import edu.stevens.cs522.chat.oneway.server.R;
import edu.stevens.cs522.chat.oneway.server.contracts.MessageContract;
import edu.stevens.cs522.chat.oneway.server.ChatReceiverService.chatBinder;

/**
 * Created by Sandeep on 3/14/2015.
 */
public class ChatApp extends Activity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
    ...
    ChatService chatRService = new ChatService();

   /* private IChatSendService sendService;
    private IChatSendService sendRService;*/
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        bindService(intent,chatRService,BIND_AUTO_CREATE);
    ...
    private class ChatService implements ServiceConnection {
        public IChatSendService sendService ;
        public void onServiceConnected(ComponentName name, IBinder service) {
            sendService = ((ChatReceiverService.chatBinder) service).getService();
    ...
    public void onClick(View view) {
        try {
            ...
            chatService.sendService.send(sendPacket);
