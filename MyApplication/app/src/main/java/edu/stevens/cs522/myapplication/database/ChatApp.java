package edu.stevens.cs522.myapplication.database;
...
public class ChatApp extends Activity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
    ...
    private Messenger sendService = null;
    ...
    private class ChatService implements ServiceConnection {
        public void onServiceConnected(ComponentName name, IBinder service) {
            sendService = new Messenger(service);
            bound = true;
    ...
    public void onClick(View view) {
        try {
            ...
            bundle.putString("ADDRESS", destAddr.getHostAddress());
            ...
            Message msg = Message.obtain(null, ChatReceiverService.SEND, 0,0);
            msg.setData(bundle);
            try {
    ...
    class resultReceiver extends ResultReceiver {
        ...
        @Override protected void onReceiveResult(int resultCode, Bundle
            ...
            if (resultCode == 100) {
                Toast.makeText(getApplicationContext(), "Message sent: " + resultData.getString("messageText"),
